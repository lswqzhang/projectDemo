package com.lswq.model.creater.prototype.order.biz;
...
public class OrderBusiness {
     ...
     * 创建订单的方法
     *
     * @param prototypeId 订单的接口对象
     */
    public void saveOrder(String prototypeId) {

        OrderApi order = null;

        try {
            order = PrototypeManager.getPrototype(prototypeId);
        } catch (Exception e) {
            e.printStackTrace();
        }
