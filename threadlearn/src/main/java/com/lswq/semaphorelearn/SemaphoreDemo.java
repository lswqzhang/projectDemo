    ...
    public static void main(String[] args) {
        ...
        Runnable worker = new Runnable() {
            ...
            public void run() {
                ...
                try {
                    //获取资源
                    System.out.println(Thread.currentThread().getName() + "\t先前TASK个数：" + demo.semaphore.availablePermits());
                    ...
                    System.out.println(Thread.currentThread().getName() + "\t之后允许TASK个数：" + demo.semaphore.availablePermits());
